...
const menuItems = [
  { title: 'User Management', url: '/super-admin', icon: Users },
  { title: 'Review Oversight', url: '/super-admin/review-oversight', icon: ClipboardList },
];
      ...
      <SidebarHeader className="p-4 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div className="text-right">
            <span className="text-sm font-semibold text-foreground block">Super Admin</span>
