...
export const Header: React.FC = () => {
  return (
    <header className="flex flex-col items-center text-center">
      ...
      />
      <h1 className="text-[rgba(16,24,40,1)] text-base font-normal mt-[46px] max-md:mt-10">
        FIU Ethics Committee
      </h1>
      <h2 className="text-[rgba(74,85,101,1)] text-xl leading-[1.4] mt-4 max-md:max-w-full">
        Ethic Committee Portal for Final International University
      </h2>
      <p className="text-[rgba(74,85,101,1)] text-base leading-6 w-[647px] mt-8 max-md:max-w-full">
